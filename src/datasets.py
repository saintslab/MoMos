...
def build_loader(dataset_obj, batch_size, shuffle, runtime):
    """Create a ``DataLoader`` from a dataset and runtime knobs.

    Args:
        dataset_obj: Dataset or subset object to iterate.
        batch_size: Number of samples per batch.
        shuffle: Whether to shuffle sample order each epoch.
        runtime: Dict with loader options such as workers and pin memory.
...
def get_dataloaders(
    ...
    """Build train/validation/test loaders and split metadata.
