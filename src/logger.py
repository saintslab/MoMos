...
class Logger:
    """Persist configuration, epoch logs, and artifacts for one run."""

    def __init__(self, run_dir):
        """Initialize run paths and in-memory log payloads."""
    ...
    def log_motif_usage(self, data):
        """Append MoMos motif usage counts and flush motif log."""
    ...
    def save(self):
        """Write the current run log JSON to disk."""
